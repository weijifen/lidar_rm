...
set(MSG_I_FLAGS "-Irplidar_ros:/home/zhanggang/PRLIDAR/catkin_ws1/src/rplidar_ros/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/zhanggang/PRLIDAR/catkin_ws1/src/rplidar_ros/msg/coordinate_msg.msg" NAME_WE)
add_custom_target(_rplidar_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rplidar_ros" "/home/zhanggang/PRLIDAR/catkin_ws1/src/rplidar_ros/msg/coordinate_msg.msg" ""
)
...
_generate_msg_cpp(rplidar_ros
  "/home/zhanggang/PRLIDAR/catkin_ws1/src/rplidar_ros/msg/coordinate_msg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_ros)
  install(CODE "execute_process(COMMAND \"/home/zhanggang/anaconda3/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_ros\")")
  # install generated code
  install(
